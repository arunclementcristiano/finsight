                  ...
                  <div key={expense.id} className="group">
                    ...
                    >
                      <div className="flex items-center space-x-3 flex-1 min-w-0">
                        <span className="text-xl flex-shrink-0">{getCategoryIcon(expense.category as string)}</span>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            <span className="font-medium text-gray-900 dark:text-white truncate">
                              {expense.text || expense.category}
                            </span>
                            <span className="font-bold text-gray-900 dark:text-white ml-3">
                          ...
                          <div className="flex items-center justify-between mt-0.5">
                            ...
                            <button className="text-xs text-blue-600 dark:text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    {/* Expanded Details */}
                    {isExpanded && (
                      <div className="ml-12 pb-3 pr-3 space-y-2 text-sm animate-in slide-in-from-top-1 duration-200">
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 space-y-2">
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <p className="font-medium">{privacy ? "•••••" : `₹${amount.toLocaleString('en-IN')}`}</p>
                            </div>
                            <div>
                              <span className="text-gray-500 dark:text-gray-400">Date</span>
                              <p className="font-medium">{fmtDateYYYYMMDDLocal(expense.date as any)}</p>
                            </div>
                            <div>
                              <span className="text-gray-500 dark:text-gray-400">Time Added</span>
                              <p className="font-medium">{formatDate(expense.createdAt || expense.date as string)}</p>
                            </div>
                          </div>
                          {expense.text && (
                            <div>
