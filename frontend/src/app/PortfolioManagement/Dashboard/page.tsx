		...
		<div className="space-y-6">
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
				...
				<div className="flex gap-2">
					<Button className="w-full" leftIcon={<PlusCircle className="h-4 w-4" />} onClick={() => window.location.assign("/PortfolioManagement/Portfolio/Holdings")}>Add Holding</Button>
				</div>
			</div>
