export const questions = [
  ...
  },
  {
    ...
    options: ["Stable", "Variable", "Uncertain"],
    helperText: "More stable income can support slightly higher equity allocations."
  },
  {
  ...
  {
    key: "sipRegularity",
    text: "How regular/large are your SIPs?",
    options: ["Low", "Medium", "High"],
    helperText: "Higher SIPs can support a slightly leaner cash buffer."
  },
  {
    key: "preferredAssets",
  ...
  {
    key: "intlEquityPreference",
    text: "Do you prefer international equity exposure?",
    options: ["No", "Some", "High"],
    helperText: "Optional. Future enhancement: tilt part of equity to international exposure."
  },
  {
    key: "rebalancingComfort",
    text: "Rebalancing style you prefer?",
    options: ["Tight", "Normal", "Loose"],
    helperText: "Controls how wide the allowed per-class bands are."
  }
];
export const questions = [
  {
