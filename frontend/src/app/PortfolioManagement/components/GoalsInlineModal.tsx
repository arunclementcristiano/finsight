...
import { CalendarDays, Shield, AlertCircle, Trash2, CheckCircle2, PauseCircle, CircleDot } from "lucide-react";
...
export default function GoalsInlineModal({ open, onClose }: { open: boolean; onClose: ()=>void }) {
	...
	return (
		<Modal open={open} onClose={onClose} title="Goals & Constraints" footer={(
			<>
